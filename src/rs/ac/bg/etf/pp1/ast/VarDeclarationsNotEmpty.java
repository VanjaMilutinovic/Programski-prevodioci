...
public class VarDeclarationsNotEmpty extends VarDeclarations {

    private VarDeclarations VarDeclarations;
    private VarDecl VarDecl;

    public VarDeclarationsNotEmpty (VarDeclarations VarDeclarations, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclarationsNotEmpty(\n");
