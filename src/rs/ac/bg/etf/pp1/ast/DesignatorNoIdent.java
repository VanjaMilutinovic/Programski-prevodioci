...
public class DesignatorNoIdent extends Designator {

    private String designatorName;
    private OptionalAccess OptionalAccess;

    public DesignatorNoIdent (String designatorName, OptionalAccess OptionalAccess) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorNoIdent(\n");
